...
OAUTH_TOKEN = "oauth:ygia9wv9ghymhh37vibfjxqbva8l7z"
NICKNAME = "multitiminho2609"
...
class Streamer():
    ...
    def end_count(self):
        ...
        # LULW = self.emotes["LULW"]
        # OMEGALUL = self.emotes["OMEGALUL"]
        # ResidentSleeper = self.emotes["ResidentSleeper"]
        # weirdChamp = self.emotes["weirdChamp"]
        # Pog = self.emotes["Pog"]
        # PogO = self.emotes["PogO"]
...
if __name__ == "__main__":
    ...
    db.create_all()
    # Emotecount.query.delete()
    # countkeys_table.query.delete()
    # db.session.commit()
    streamer_obj = []
    scraper_obj = []
    for streamer in STREAMERS:
...
STREAMERS = ["mizkif", "ludwig", "xqcow", "imrosen", "esfandtv"]
